...
function HomeAiestimator({isMobile}){
    return(
        <>{isMobile?
            <div className='homepage-aiestimator row m-0 mb-3 bg-blue'  style={{height:'150px'}}>
              <div className='col-4 text-center d-flex flex-column align-items-center justify-content-center bg-transparent' >
                ...
                <div className='col-8 p-3 d-flex align-items-center justify-content-center  bg-transparent text-black'>
                  <Text fontColor='text-black'> Simply Generate RFQs with Artificial Intelligence and <br />save a lot of time and work! </Text> 
                </div>
                
                
            </div>
            :
            <div className='homepage-aiestimator row m-0 mb-3 pt-5'>
                  <div className='col-8 p-3 d-flex align-items-center justify-content-center  bg-blue text-black' style={{height:'100px'}}>
                    <Text fontColor='text-black'> Simply Generate RFQs with Artificial Intelligence and <br />save a lot of time and work! </Text> 
                  </div>
          ...
          {isMobile?
            <div className='homepage-aiestimator row m-0 bg-green'  style={{height:'150px'}}>
                <div className='col-8 p-3 d-flex align-items-center justify-content-center  bg-transparent text-black'>
                  <Text fontColor='text-black'> Simple make estimation with certain parameters <br />or designs with the help of Artificial Intelligence </Text> 
                </div>
            ...
            :
            <div className='homepage-aiestimator row m-0 pt-5'>
                  <div className='col-4 d-flex align-items-center justify-content-center bg-transparent'>
                  ...
                  <div className='col-8 p-3 d-flex align-items-center justify-content-center  bg-green text-black' style={{height:'100px'}}>
                    <Text fontColor='text-black'> Simple make estimation with certain parameters <br />or designs with the help of Artificial Intelligence </Text> 
                  </div>
            </div>}</>
    )
