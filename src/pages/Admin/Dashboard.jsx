...
import BarLineChart from "@/components/admin/charts/BarChart";
import DonutChart from "@/components/admin/charts/DoughNut";
import VectorMap from "@/components/admin/maps/us";
...
const DashBoard = ({API_URL , Companyname, isLoggedIn, loggedInUser,categories=[] })=>{
    ...
    const showHideMenu = (e) => {
      ...
      const rawStateData = {
        AL: 0.5, AK: 0.3, AZ: 0.7, AR: 0.4, CA: 15.2, CO: 1.0, CT: 1.1, DE: 0.3,
        FL: 4.2, GA: 3.0, HI: 0.3, ID: 0.2, IL: 3.9, IN: 2.8, IA: 0.9, KS: 0.8,
        KY: 1.3, LA: 1.6, ME: 0.3, MD: 1.9, MA: 2.3, MI: 3.0, MN: 2.0, MS: 1.0,
        MO: 2.0, MT: 0.3, NE: 0.4, NV: 0.6, NH: 0.3, NJ: 2.8, NM: 0.6, NY: 8.1,
        NC: 3.2, ND: 0.3, OH: 3.5, OK: 1.6, OR: 1.5, PA: 3.9, RI: 0.3, SC: 2.2,
        SD: 0.3, TN: 2.0, TX: 8.6, UT: 1.0, VT: 0.2, VA: 2.6, WA: 2.7, WV: 0.6,
        WI: 2.2, WY: 0.2
      };
      
      const stateData = Object.fromEntries(
        Object.entries(rawStateData).map(([key, value]) => [`US-${key}`, value])
      );
    
    const topStates = Object.entries(rawStateData)
        .sort(([, a], [, b]) => b - a)
        .slice(0, 10);
    return(
        <div id="wrapper">
            ...
            <div id="page" className="">
                ...
                <div id="layout-wrap" className="layout-wrap">
                    ...
                    {/* <!-- /preload --> */}
                    {/* <!-- section-menu-left --> */}
                    <SideBar activeMenu={0} onshowHideMenu={showHideMenu} />
                    {/* <!-- /section-menu-left --> */}
                                    ...
                                    <div className="tf-section-4 mb-30">
                                        ...
                                        <div className="wg-chart-default">
                                            <div className="top">
                                                ...
                                                <DropDown 
                                                    dropdownbtn={<div className="dropdown-toggle bg-transparent w-100" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <span className="view-all">Yearly<i className="icon-chevron-down" ></i></span>
                                                    </div>}
                                                    content={<>
                                                                <li>  
                                                                    <a href="javascript:void(0);"><div className="body-title-2">Monthly</div></a>
                                                                </li>
                                                                <li>
                                                                <a href="javascript:void(0);"><span className="body-title-2"> </span></a>
                                                                </li>
                                                                <li>  
                                                                    <a href="javascript:void(0);"><div className="body-title-2">Weekly</div></a>
                                                                </li>
                                                                                
                                                            </>}/>
                                            </div>
                                            <LineChart  color='#22C55E' />
                                        </div>
                                        {/* <!-- /chart-default --> */}
                                        {/* <!-- chart-default --> */}
                                        <div className="wg-chart-default">
                                        ...
                                        <div className="flex gap20 flex-wrap-mobile">
                                            ...
                                            <div className="wg-box w-half">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="dropdown default style-box">
                                                        <button className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <a href="product-list.html" className="view-all">Weekly<i className="icon-chevron-down"></i></a>
                                                        </button>
                                                        <ul className="dropdown-menu">
                                                            <li>  
                                                ...
                                                <ul className="flex flex-column h-full has-divider-line">
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">Neptune Longsleeve</a>
                                                                </div>
                                                    ...
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">Ribbed Tank Top</a>
                                                                </div>
                                                    ...
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">Ribbed modal T-shirt</a>
                                                                </div>
                                                    ...
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">Oversized Motif T-shirt</a>
                                                                </div>
                                                    ...
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">V-neck linen T-shirt</a>
                                                                </div>
                                                    ...
                                                    <li className="wg-product">
                                                        <div className="name flex-grow">
                                                            ...
                                                            <div>
                                                                <div className="title">
                                                                    <a href="#" className="body-text">Jersey thong body</a>
                                                                </div>
                                    ...
                                    <div className="tf-section-5">
                                            ...
                                            <div className="wg-table table-recent-orders">
                                                ...
                                                <ul className="flex flex-column has-divider-line has-line-bot">
                                                    <li className="item wg-product gap20">
                                                        ...
                                                        <div className="body-text text-main-dark mt-4">Leslie Alexander</div>
                                                        <div className="body-text text-main-dark mt-4">1452</div>
                                                        <div className="body-text text-main-dark mt-4">X1</div>
                                                        <div className="body-text text-main-dark mt-4">$138</div>
                                                        <div>
                                                    ...
                                                    <li className="item wg-product gap20">
                                                        ...
                                                        <div className="body-text text-main-dark mt-4">$138</div>
                                                        <div>
                                                            <div className="block-published fw-7">Processing</div>
                                                        </div>
                                                    </li>
                                                    <li className="item wg-product gap20">
                                                        <div className="name">
                                        ...
                                        <div className="wg-box">
                                            ...
                                            <div className="wrap-usa-vectormap">
                                                <VectorMap data={stateData} />
                                                <div className="bot">
                                                {topStates.slice(0,3).map((state, index)=>(
                                                            <div key={index} className="block-legend">
                                                                <div className="dot t6"></div>
                                                                <div className="text-tiny text-surface-2">{state[USA]} -{state}- <span className="fw-7 text-main-dark">40%</span></div>
                                                            </div>
                                                        ))}
                                                    <div className="flex items-center justify-between gap20 mb-20">
                                                        ...
                                                        <div className="block-legend">
                                                            <div className="dot t6"></div>
                                                            <div className="text-tiny text-surface-2">California <span className="fw-7 text-main-dark">40%</span></div>
                                                        </div>
                                                        <div className="block-legend">
                                                            <div className="dot t6"></div>
                                                            <div className="text-tiny text-surface-2">Arizona <span className="fw-7 text-main-dark">15%</span></div>
                                                        </div>
                                                        <div className="block-legend">
                                                            <div className="dot t3"></div>
                                                            <div className="text-tiny text-surface-2">Texas <span className="fw-7 text-main-dark">10%</span></div>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center justify-between gap20">
                                                        <div className="block-legend">
                                                            <div className="dot t3"></div>
                                                            <div className="text-tiny text-surface-2">Georda <span className="fw-7 text-main-dark">3.5%</span></div>
                                                        </div>
                                                        <div className="block-legend">
                                                            <div className="dot t3"></div>
                                                            <div className="text-tiny text-surface-2">North Carolina <span className="fw-7 text-main-dark">2%</span></div>
                                                        </div>
                                                        <div className="block-legend">
                                                            <div className="dot t3"></div>
                                                            <div className="text-tiny text-surface-2">Florida <span className="fw-7 text-main-dark">1.5%</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
