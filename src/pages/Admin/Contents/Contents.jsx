    ...
    return (
      <>
        ...
        <List 
                ...
                suffix={<Icon icon="material-symbols-light:download-rounded" width="24" height="24" style={{color:'#5d92b3'}} onClick={() => handleDownloadContent(item?.file_name,item?.picture)} />} 
                />
        :
        <Table
          id='contents-table'
