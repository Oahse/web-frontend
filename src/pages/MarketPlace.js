    ...
    <div className="explore">
      <span className='d-flex flex-column topbar'>
        ...
        <div className={!isSearch && `homepage-content`}>
            ...
            <div className='mt-4'>
              {isSearch && <Breadcrumb items={Breadcrumbitems} />}
        ...
        {isSearch ?
            <div className=' mx-4'>
              ...
              <div className='mx-2'>
                ...
                {isDesktop ? 
                  <MiddleVerticalScroller title={'Trending'} items={trending} toCurrency={"USD"} noitemsPerPage={noitemsPerPage} />
                  :
                  <MiddleHorizontalScroller title={'Trending'} items={trending} toCurrency={"USD"} />
                  }
                {isDesktop ? 
                  <MiddleVerticalScroller title={'New Arrivals'} items={newarrivals} toCurrency={"USD"} noitemsPerPage={noitemsPerPage} />
                  :
                  <MiddleHorizontalScroller title={'New Arrivals'} items={newarrivals} toCurrency={"USD"} />
                  }
                {isDesktop ? 
                  <MiddleVerticalScroller title={'Brands'} items={newarrivals} toCurrency={"USD"} noitemsPerPage={noitemsPerPage} />
                  :
